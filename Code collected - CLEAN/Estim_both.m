...
dynare sticky_wages_both noclearall
...
moments = 1*[ 
   pi_p_eps_i(period1:numb)-SIRF_int(period1:numb,3);
   pi_w_eps_i(period1:numb)-SIRF_int(period1:numb,4);
   y_eps_i(period1:numb)-SIRF_int(period1:numb,5);
   n_eps_i(period1:numb)-SIRF_int(period1:numb,6);
...
SIRF_up = [SIRF_up_int, SIRF_up_tech];
SIRF_low = [SIRF_low_int, SIRF_low_tech];


n = 20; % Size of the small square matrix
m = 8; % Number of times to repeat the pattern along the diagonal
