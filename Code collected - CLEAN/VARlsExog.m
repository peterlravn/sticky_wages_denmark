function [Beta,CovBeta,tratioBeta,res,indep,so]=VARlsExog(y,p,con,tr,exog);
% Input:
% y = T*K matrix
% p = number of lags
% con = 1 add constant otherwise no constant
% tr = 1 add linear trend otherwise no trend
% Exog = Exogenous variables; this is a scalar if no exog variables
%
% Output:
...
% Add exogenous variables if needed, i.e., if exog is a matrix
