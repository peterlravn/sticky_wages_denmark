function [norm,multnorm_table]=multnorm(umat);
%{
**
...
%}
  ...
  multnorm_table = table(categorical({'joint test statistic:' ; 'p-value' ; 'degrees of freedom' ; 'Skewness only' ; 'p-value' ; 'kurtosis only'; 'p-value'}),norm(:,1),norm(:,2),'VariableNames',{'Test' 'Doornik_Hansen' 'Lutkepohl'});
