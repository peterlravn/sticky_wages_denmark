...
residual = zeros(12, 1);
    ...
    residual(10) = (y(9)) - (y(1)*params(11)+params(12)*y(12)+y(9)*params(10)+x(1));
    residual(11) = (y(12)) - (y(4)-(y(4)));
    residual(12) = (y(11)) - (y(11)*params(9)+x(2));
